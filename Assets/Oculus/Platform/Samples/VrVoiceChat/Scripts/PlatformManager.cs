namespace Oculus.Platform.Samples.VrVoiceChat
{
	...
	public class PlatformManager : MonoBehaviour
	{
		...
		private RoomManagerOculusDos m_roomManager;
		...
		void Awake()
		{
			...
			m_roomManager = new RoomManagerOculusDos();
		...
		public static void SetActiveInvites(List<RoomManagerOculusDos.Invite> invites)
		{
